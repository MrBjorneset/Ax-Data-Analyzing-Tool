...
PLOT_PRESETS = {
    "Full dashboard (17 plots)": [
        ...
        {"title": "Phase Position 0",                "vars": ["phase position 0"]},
        {"title": "Line Speed (mm/s)",               "vars": ["line speed"]},
        {"title": "Main PCB Zinc Temperature (°C)",  "vars": ["zinc temp"]},
        {"title": "ITM Ink & MUM Makeup Levels (%)", "vars": ["itm level", "mum level"]},
        {"title": "Charge Electrode Offset",         "vars": ["charge electrode offset 0"]},
        {"title": "Jet ON = 1 & Jet OFF = 0",        "vars": ["jet on"]},
    ],
    "Key parameters (6 plots)": [
        {"title": "Ink system pressure",     "vars": ["ink system pressure (", "pressure set point"]},
        {"title": "Viscosity",               "vars": ["actual cp @ 25", "target cp @ 25"]},
